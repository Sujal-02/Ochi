    ...
    <div className='w-full h-screen bg-zinc-900 p-20 flex'>
        <div className='w-1/2 h-full flex flex-col justify-between font-founders-grotesk'>
            <div className='heading flex flex-col justify-between'>
                <div className='text-[8vw] uppercase -mb-5 leading-none tracking-tight'>Eye-</div>
                <div className='text-[8vw] uppercase -mb-5 leading-none tracking-tight'>opening</div>
            </div>
        ...
        <div className='w-1/2 h-full font-founders-grotesk'>
            <h1 className='text-[8vw] uppercase -mb-5 leading-none tracking-tight'>Presentations</h1>
            <div className='dets font-["Neue_Montreal"] mt-10'>
                <span className='block mb-5 text-sm'>S:</span>
                <a className='block text-sm font-light underline'>Instagram</a>
                <a className='block text-sm font-light underline'>Facebook</a>
                <a className='block text-sm font-light underline'>Linkedin</a>
                <a className='block text-sm font-light underline'>Behance</a>
            </div>
            <div className='dets font-["Neue_Montreal"] mt-5'>
                <span className='block mb-5 text-sm'>L:</span>
                <a className='block text-sm font-light underline'>202-1965 W 4th Ave</a>
                <a className='block text-sm font-light underline'>Vancouver, Canada</a>
                <a className='block text-sm font-light underline mt-5'>30 Chukarina St</a>
                <a className='block text-sm font-light underline'>Lviv, Ukraine</a>
            </div>
            <div className='dets font-["Neue_Montreal"] mt-5'>
                <span className='block mb-5 text-sm'>E:</span>
                <a className='block text-sm font-light underline'>hello@ochi.design</a>
            </div>
            <div className='mt-10 font-["Neue_Montreal"] font-light text-md text-zinc-600'>&copy; ochi design 2024. Legal Terms</div>
        </div>
    </div>
  )
}
